    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      ...
      <div className="prose prose-sm sm:prose prose-blue max-w-none">
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Getting Started</h2>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Types of Canvases</h2>
          <p className="text-gray-600 mb-4">
          ...
          <ul className="list-none space-y-4">
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">Visualize and analyze your entire business model.</p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">Focus on your product-market fit and customer value.</p>
              </div>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">Evaluate your Strengths, Weaknesses, Opportunities, and Threats.</p>
              </div>
            </li>
            <li className="flex items-start">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Creating and Editing a Canvas</h2>
