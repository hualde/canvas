...
export default function GoogleValuePropositionCanvas() {
  const navigate = useNavigate();

  const canvasData = {
    title: "Google Inc. Value Proposition Canvas",
    content: {
      productsAndServices: [
        "• Google Search",
        "• Google Ads",
      ...
      gainCreators: [
        ...
        "• Free, feature-rich productivity tools",
      ...
      painRelievers: [
        ...
        "• Free cloud storage and collaboration tools",
      ...
      pains: [
        ...
        "• Privacy concerns",
        "• Difficulty in online advertising",
        "• Complexity of digital tools",
        "• Data management and security issues"
      ]
    },
    project_name: "Google Inc. Value Proposition Analysis",
    author: "Business Strategy Team",
    date: "2023-05-15",
    comments: "This canvas provides an overview of Google Inc.'s value proposition as of 2023."
  };
