...
export default function AmazonBusinessModelCanvas() {
  const navigate = useNavigate();

  const canvasData = {
    title: "Amazon Inc. Business Model Canvas",
    content: {
      keyPartners: [
        "• Third-party sellers",
      ...
      keyActivities: [
        ...
        "• Cloud services (AWS) development and operations",
      ...
      valuePropositions: [
        ...
        "• Competitive pricing",
        "• Fast and reliable delivery (Prime)",
      ...
      customerSegments: [
        "• Online shoppers (B2C)",
        "• Third-party sellers (B2B)",
        "• Prime members",
        "• Businesses (AWS clients)",
        "• Content consumers (Prime Video, Kindle)"
      ],
      costStructure: [
    ...
    project_name: "Amazon Inc. Analysis",
    author: "Business Strategy Team",
    date: "2023-05-15",
    comments: "This canvas provides an overview of Amazon Inc.'s business model as of 2023."
  };
